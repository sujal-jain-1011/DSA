...
/*Function to insert an element into the binary search tree given by user as input*/
...
int main(void)
{
    ...
    if(createBinarySearchTree())
    {
        ...
        printf("Enter element to be inserted in binary search tree:");
        scanf("%d", &elm); insert(NULL, &root, elm);
        printf("The preorder traversal of binary search tree after insertion:\n");
