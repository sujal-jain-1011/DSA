...
and inssert an element in the binary search tree from the given user input using recursion*/
...
class BinarySearchTree{
    ...
    void insert(TreeNode parentNode, TreeNode childNode, int element)
    {
        ...
        if(childNode!=null)
        {
            ...
            if(childNode.val>element) insert(childNode, childNode.left, element);
            else if(childNode.val<element) insert(childNode, childNode.right, element);
            else System.out.println("Duplicate element not allowed");
        }
        else
        {
...
public class Program_1
{
    ...
    public static void main(String[] args)
    {
        ...
        if(BST.createBinarySearchTree())
        {
            ...
            System.out.print("Enter element to be inserted in binary search tree:");
            Scanner sc=new Scanner(System.in); elm=sc.nextInt();
            BST.insert(null, BST.root, elm);
            System.out.println("The preorder traversal of binary search tree after insertion:");
