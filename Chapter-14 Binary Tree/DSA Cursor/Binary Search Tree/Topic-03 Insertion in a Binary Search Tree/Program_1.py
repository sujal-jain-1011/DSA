...
class BinarySearchTree:
        ...
        def insert(self, parentNode, childNode, element):
...
if(BST.createBinarySearchTree()):
    ...
    elm=int(input("Enter element to be inserted in binary search tree:"))
    BST.insert(None, BST.root, elm)
    print("The preorder traversal of binary search tree after insertion:")
