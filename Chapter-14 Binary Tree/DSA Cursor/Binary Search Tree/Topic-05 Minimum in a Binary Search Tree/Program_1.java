...
class BinarySearchTree{
    ...
    int minBST(TreeNode root_add)
    {
        /*Declaring base case for recursion: when left subtree of binary search tree is/becomes empty*/
        if(root_add.left!=null) return minBST(root_add.left); else return root_add.val;
    }
};
...
public class Program_1
{
    ...
    public static void main(String[] args)
    {
        ...
        if(BST.createBinarySearchTree())
        {
            ...
            if(BST.root==null) System.out.println("Can't find minimum since binary search tree is empty!");
            else System.out.println("The minimum element in binary search tree is:"+BST.minBST(BST.root));
        }
        else
