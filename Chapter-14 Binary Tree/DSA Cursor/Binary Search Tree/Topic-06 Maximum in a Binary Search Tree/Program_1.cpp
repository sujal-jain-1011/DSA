...
array and to find the maximum element in the binary search tree using recursive approach*/
...
class BinarySearchTree{
    ...
    public:
        ...
        /*Member function of class: to find the maximum element in binary search tree using recursive approach*/
        int maxBST(struct TreeNode** root_add)
        {
            /*Declaring base case for recursion: when right subtree of binary search tree is/becomes empty*/
            if((*(root_add))->right) return maxBST(&((*(root_add))->right)); else return (*(root_add))->val;
        }
...
int main(void)
{
    ...
    if(BST.createBinarySearchTree())
    {
        ...
        if(!(BST.root)) cout<<"Can't find maximum since binary search tree is empty!"<<endl;
        else cout<<"The maximum element in binary search tree is:"<<BST.maxBST(&(BST.root))<<endl;
