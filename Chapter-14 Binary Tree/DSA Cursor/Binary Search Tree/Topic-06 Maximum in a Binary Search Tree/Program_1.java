...
class BinarySearchTree{
    ...
    int maxBST(TreeNode root_add)
    {
        /*Declaring base case for recursion: when right subtree of binary search tree is/becomes empty*/
        if(root_add.right!=null) return maxBST(root_add.right); else return root_add.val;
    }
};
...
public class Program_1
{
    ...
    public static void main(String[] args)
    {
        ...
        if(BST.createBinarySearchTree())
        {
            ...
            if(BST.root==null) System.out.println("Can't find maximum since binary search tree is empty!");
            else System.out.println("The maximum element in binary search tree is:"+BST.maxBST(BST.root));
        }
        else
