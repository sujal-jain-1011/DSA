...
if(BST.createBinarySearchTree()):
    ...
    print()
    if(not(BST.root)):
        print("Can't find maximum since binary search tree is empty!")
    else:
        print(f"The maximum element in binary search tree is:{BST.maxBST(BST.root)}")
else:
