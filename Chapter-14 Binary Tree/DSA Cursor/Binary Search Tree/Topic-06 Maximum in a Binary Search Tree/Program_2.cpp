...
array and to find the maximum element in the binary search tree using iterative approach*/
...
class BinarySearchTree{
    ...
    public:
        ...
        /*Member function of class: to find the maximum element in binary search tree using iterative approach*/
        int maxBST(struct TreeNode** root_add)
        {
            /*Running a while loop to get the rightmost node of the binary search tree*/
            struct TreeNode* ptr=(*(root_add)); while(ptr->right) ptr=ptr->right; return ptr->val;
        }
