...
# 135 "Program_2.cpp"
        ...
        void check(struct TreeNode** root_add, struct TreeNode** ptr, bool* isfd)
        {
            ...
            if((*(root_add)) && (*(isfd)))
            {
                ...
                if((*(ptr))){if((*(ptr))->val>=(*(root_add))->val) (*(isfd))=false;}
                (*(ptr))=(*root_add);
        ...
        short unsigned int checkBST(struct TreeNode** root_add)
        {
            ...
            struct TreeNode* ptr=nullptr; bool isFound=true;
