...
class BinarySearchTree{
    ...
    public:
        ...
        /*Member function of class: to swap node values of two nodes of the binary search tree*/
...
int main(void)
{
    ...
    {
        cout<<"Successfully created binary search tree!"<<endl;
        cout<<"The preorder traversal of binary search tree is:"<<endl;
        ...
        BinarySearchTree::TreeNode*** arr=new BinarySearchTree::TreeNode**[BST.capacity];
        long long unsigned int iter=0; BST.inorderPopulate(&(BST.root), arr, &iter);
        ...
        cout<<"Enter the node indices of whose data you need to swap:";
        cin>>first>>second; first%=BST.capacity; second%=BST.capacity;

        /*Swapping the node values of the indices (nodes in the inorder traversal of BST) given by user*/
        BST.swap((*(arr+first)), (*(arr+second)));
        ...
        cout<<"The inorder traversal of BST after distortion is:"<<endl;
        ...
        BinarySearchTree::TreeNode*** array=new BinarySearchTree::TreeNode**[5];
        for(short unsigned int iter=0; iter<5; iter++) array[iter]=nullptr;
        cout<<"Recovering BST..."<<endl; BST.recoverBST(&(BST.root), array);
        if(!array[3]) BST.swap((*(array+2)), (*(array+4))); 
        else BST.swap((*(array+2)), (*(array+3)));

        /*Calling inorder function to print the inorder traversal of the recovered BST*/
        cout<<"The inorder traversal of recovered BST is:"<<endl; BST.inorder(&(BST.root)); cout<<endl;
