...
and print the postorder traversal of binary tree using the depth first search algorithm*/
...
class BinaryTree{
    ...
    /*Member function of class: to print the postorder traversal the binary tree by taking the root node*/
    void postorder(TreeNode root_add)
    {
        /*Declaring base case for recursion: when the binary tree is/becomes empty*/
        if(root_add!=null)
        {
            /*Calling postorder function recursively for left subtree, then calling it recur-
            sively for right subtree and then printing the value of current node to console*/
...
public class Program_1
{
    ...
    public static void main(String[] args)
    {
        ...
        if(BT.createBinaryTree())
        {
            ...
            System.out.println("The postorder traversal of binary tree is:");
