...
class BinaryTree{
    ...
    /*Member function of class: to print the inorder traversal the binary tree by taking the root node*/
...
public class Program_1
{
    ...
    public static void main(String[] args)
    {
        ...
        if(BT.createBinaryTree())
        {
            ...
            System.out.println("The inorder traversal of binary tree is:");
            BT.inorder(BT.root);
            System.out.println();
        }
        else
