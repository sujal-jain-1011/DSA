...
and we are going to find the maximum element in binary tree using iterative approach*/
...
/*Function to find the maximum element in binary tree using iterative approach*/
int maxInBinaryTree(struct TreeNode** root_add)
{
    ...
    else
    {
        ...
        else
        {
            ...
            {
                /*Getting and removing the front element of the queue, comparing maxel variable
                ...
                if(qptr)
                {
                    ...
                    maxel=qptr->val>maxel?qptr->val:maxel;
...
int main(void)
{
    ...
    if(createBinaryTree())
    {
        ...
        printf("The maximum element in binary tree is:%d\n", maxInBinaryTree(&root));
    }
