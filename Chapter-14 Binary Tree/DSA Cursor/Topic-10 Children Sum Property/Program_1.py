...
class BinaryTree:
        ...
        def csp(self, root_add):
            ...
            if(not(root_add.left) and not(root_add.right)):
                ...
                if(root_add.left):
                    leftChild=root_add.left.val
                if(root_add.right):
                    rightChild=root_add.right.val
                ...
                return 0 if(root_add.val!=(leftChild+rightChild)) else self.csp(root_add.left) and self.csp(root_add.right)
...
if(BT.createBinaryTree()):
    ...
    if(BT.csp(BT.root)):
        print("Children sum property exists in binary tree!")
    else:
        print("Children sum property does not exist in binary tree!")
else:
