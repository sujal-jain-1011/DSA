        ...
        else
        {
            ...
            while(!queLOT.isEmpty())
            {
                ...
                if(qptr!=null)
                {
                    ...
                    if(qptr.left!=null || qptr.right!=null)
                    {
                        /*Enqueuing child nodes of the current node into queue if they exist*/
                        if(qptr.left!=null) {queLOT.offer(qptr.left); leftChild=qptr.left.val;}
                        if(qptr.right!=null) {queLOT.offer(qptr.right); rightChild=qptr.right.val;}
