...
class BinaryTree{
    ...
    int heightBalancedBT(TreeNode root_add)
    {
        ...
        else
        {
            ...
            int leftHeight=root_add.left!=null?heightBalancedBT(root_add.left):0;
            if(leftHeight==-1) return -1;
            int rightHeight=root_add.right!=null?heightBalancedBT(root_add.right):0;
...
public class Program_1
{
    ...
    public static void main(String[] args)
    {
        ...
        if(BT.createBinaryTree())
        {
            ...
            if(BT.heightBalancedBT(BT.root)==-1)
            System.out.println("Binary tree is not height balanced!");
            else System.out.println("Binary tree is height balanced!");
        }
        else
