...
class BinaryTree:
        ...
        def heightBalancedBT(self, root_add):
            ...
            if(not(root_add.left) and not(root_add.right)):
                ...
                leftHeight=self.heightBalancedBT(root_add.left) if(root_add.left) else 0
                if(leftHeight==-1):
                    return -1
                rightHeight=self.heightBalancedBT(root_add.right) if(root_add.right) else 0
                if(rightHeight==-1):
                    return -1
...
if(BT.createBinaryTree()):
    ...
    if(BT.heightBalancedBT(BT.root)==-1):
        print("Binary tree is not height balanced!")
    else:
        print("Binary tree is height balanced!")
else:
