...
and we are going to print the left view of the binary tree using recursive approach"""
...
class BinaryTree:
        ...
        """Member function of class: to print the left view of the binary tree using recursive approach, for
        this we are going to use a class variables to keep track of visited level and current level"""
        def leftView(self, root_add, currentLevel):
            ...
            if(root_add):
                ...
                """Calling leftView function recursively for left and right subtrees of current node
                with the value of currentLevel increased by one, since we are traversing downwards"""
                self.leftView(root_add.left, currentLevel+1)
                self.leftView(root_add.right, currentLevel+1)
...
if(BT.createBinaryTree()):
    ...
    print("The left view of binary tree is:")
