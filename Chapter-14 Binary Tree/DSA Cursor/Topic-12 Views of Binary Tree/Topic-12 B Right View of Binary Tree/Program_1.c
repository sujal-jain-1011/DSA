...
/*Function to print the right view of the binary tree using recursive approach, for this
we are going to use a global variable to keep track of visited level and current level*/
long long unsigned int visitedLevel=0;
...
int main(void)
{
    ...
    if(createBinaryTree())
    {
        ...
        printf("The right view of the binary tree is:\n");
        rightView(&root, 1);
        printf("\n");
    }
