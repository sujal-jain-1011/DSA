...
class BinaryTree{
    ...
    public:
        ...
        void rightView(struct TreeNode** root_add, long long unsigned int currentLevel)
        {
            ...
            if(*(root_add))
            {
                ...
                rightView(&((*root_add)->right), currentLevel+1);
                rightView(&((*root_add)->left), currentLevel+1);
            }
        }
