...
class BinaryTree{
    ...
    /*Member function of class: to print the right view of the binary tree using iterative approach*/
        ...
        else
        {
            ...
            while(!(queLOT.isEmpty()))
            {
                ...
                if(qptr!=null)
                {
                    ...
                    tempArray.add(qptr.val);
                    if(qptr.left!=null) queLOT.add(qptr.left);
                    if(qptr.right!=null) queLOT.add(qptr.right);
                }
                else
                {
                    /*Enqueuing NULL into queue to mark the ending of the current level*/
                    System.out.print(tempArray.get((int)(tempArray.size()-1))+" ");
                    tempArray.clear();
