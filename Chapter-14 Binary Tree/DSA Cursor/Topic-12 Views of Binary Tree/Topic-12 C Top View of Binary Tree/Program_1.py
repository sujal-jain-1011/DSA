                ...
                while(bool(queLOT)):
                    ...
                    if(p[0]):
                        ...
                        if(p[0].left):
                            ...
                            leftPair=[p[0].left, p[1]-1]
                            queLOT.append(leftPair)
                        if(p[0].right):
                            #Enqueuing right child node along with it's level into queue
                            rightPair=[p[0].right, p[1]+1]
                            queLOT.append(rightPair)
...
if(BT.createBinaryTree()):
    ...
    print("The top view of binary tree is:")
    BT.topView(BT.root)
    print()
else:
