...
/*Including limits.h header file for using ULLONG_MAX, stdio.h header file for input and output functions,
stdlib.h header file for memory allocation functions and generic_map.h header file for using custom map*/
#include<limits.h>
#include<stdio.h>
#include<stdlib.h>
...
int main(void)
{
    ...
    if(createBinaryTree()) printf("Successfully created binary tree!\n");
