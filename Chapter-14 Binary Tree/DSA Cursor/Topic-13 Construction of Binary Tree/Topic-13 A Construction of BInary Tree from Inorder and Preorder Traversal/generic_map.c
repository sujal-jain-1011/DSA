...
/*Including stdlib.h header file for using the functions for dynamically allocating memory, string.h header file for using the standard string functions,
uthash.h header file for unordered map implementation and generic_map.h to include all the forward declarations of the functions defined earlier*/
#include<stdlib.h>
#include<string.h>
#include "uthash.h"
