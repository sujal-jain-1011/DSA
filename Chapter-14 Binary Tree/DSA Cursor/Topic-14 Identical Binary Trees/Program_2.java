    ...
    boolean isIdentical(TreeNode root_add_1, TreeNode root_add_2)
    {
        ...
        while(!qu.isEmpty())
        {
            ...
            else
            {
                ...
                pair<TreeNode, TreeNode> leftPair=new pair<>(qptr_1.left, qptr_2.left);
                pair<TreeNode, TreeNode> rightPair=new pair<>(qptr_1.right, qptr_2.right);
        ...
        if(BT.createBinaryTree(0) && BT.createBinaryTree(1))
            {
                ...
                if(BT.isIdentical(BT.rootNodes[0], BT.rootNodes[1])) System.out.println("Binary trees are identical!");
                else System.out.println("Binary trees are not identical!");
            }
