        ...
        def isIdentical(self, root_add_1, root_add_2):
            ...
            while(bool(qu)):
                ...
                if(not(qptr_1) and not(qptr_2)):
                    ...
                    qu.append([qptr_1.left, qptr_2.left])
                    qu.append([qptr_1.right, qptr_2.right])
...
if(BT.createBinaryTree(0) and BT.createBinaryTree(1)):
    ...
    if(BT.isIdentical(BT.rootNodes[0], BT.rootNodes[1])):
        print("Binary trees are identical!")
    else:
        print("Binary trees are not identical!")
else:
