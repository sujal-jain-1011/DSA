        ...
        bool isIdentical(struct TreeNode** root_add_1, struct TreeNode** root_add_2)
        {
            ...
            while(!qu.empty())
            {
                ...
                else
                {
                    ...
                    qu.push({qptr_1->left, qptr_2->left});
                    qu.push({qptr_1->right, qptr_2->right});
                }
            }
...
int main(void)
{
    ...
    if(BT.createBinaryTree(0) && BT.createBinaryTree(1))
    {
        ...
        if(BT.isIdentical(BT.rootNodes+0, BT.rootNodes+1)) cout<<"Binary trees are identical!"<<endl;
        else cout<<"Binary trees are not identical!"<<endl;
    }
