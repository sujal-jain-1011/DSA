...
class BinaryTree{
    ...
    boolean isMirror(TreeNode root_add_1, TreeNode root_add_2)
    {
        ...
        if(BT.createBinaryTree(0) && BT.createBinaryTree(1))
            {
                ...
                if(BT.isMirror(BT.rootNodes[0], BT.rootNodes[1])) System.out.println("Binary trees are mirror images!");
                else System.out.println("Binary trees are not mirror images!");
            }
