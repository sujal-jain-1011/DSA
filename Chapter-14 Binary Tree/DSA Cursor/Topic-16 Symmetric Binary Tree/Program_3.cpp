...
for memory allocation functions, queue file for using queue data structure and utility file for using pair data structure*/
#include<iostream>
#include<limits.h>
#include<new>
#include<queue>
...
class BinaryTree{
    ...
    public:
        ...
        bool isSymmetric(struct TreeNode** root_add_1, struct TreeNode** root_add_2)
        {
