...
class BinaryTree{
    ...
    public:
        ...
        /*Member function of class: to swap two pointers of the type (struct TreeNode*)*/
...
int main(void)
{
    ...
    if(BT.createBinaryTree())
    {
        ...
        cout<<"The preorder traversal of binary tree before inversion is:"<<endl;
        BT.preorder(&(BT.root)); cout<<endl;

        /*Calling insvert function to invert the binary tree*/
        BT.invert(&(BT.root));
        cout<<"The preorder traversal of binary tree after inversion is:"<<endl;
        BT.preorder(&(BT.root)); cout<<endl;
