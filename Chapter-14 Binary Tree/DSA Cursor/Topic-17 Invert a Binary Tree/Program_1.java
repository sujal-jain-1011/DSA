...
class BinaryTree{
    ...
    void invert(TreeNode root_add)
    {
        ...
        if(root_add!=null)
        {
            ...
            TreeNode tempPtr=root_add.left; root_add.left=root_add.right; root_add.right=tempPtr;
        ...
        if(BT.createBinaryTree())
            {
                ...
                System.out.println("The preorder traversal of binary tree before inversion is:");
                BT.preorder(BT.root); System.out.println();
                
                /*Calling insvert function to invert the binary tree*/
                BT.invert(BT.root);
                System.out.println("The preorder traversal of binary tree after inversion is:");
                BT.preorder(BT.root); System.out.println();
            }
