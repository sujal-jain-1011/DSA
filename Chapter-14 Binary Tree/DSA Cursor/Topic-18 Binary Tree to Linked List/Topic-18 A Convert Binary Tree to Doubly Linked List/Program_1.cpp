...
/*Including iostream header file for input and output functions, limits.h header file for using ULLONG_MAX,
new header file for memory allocation functions and utility file for using the pair data structure*/
#include<iostream>
#include<limits.h>
#include<new>
#include<utility>
    ...
    public:
        ...
        void DLLTraversal(struct TreeNode* headPtr)
        {
            ...
            while(headPtr)
            {
                ...
                cout<<"The value of current node is:"<<headPtr->val<<endl;
                cout<<"The address of current node is:"<<headPtr<<endl;

                /*Printing the addresses of previous node and next node*/
                cout<<"The address of previous node is:"<<headPtr->left<<endl;
                cout<<"The address of next node is:"<<headPtr->right<<endl;
                cout<<endl;
        ...
        pair<TreeNode*, TreeNode*> btToDLL(struct TreeNode** root_add)
        {
            ...
            if((*root_add))
            {
                ...
                struct TreeNode* leftHead=leftPair.first;
                struct TreeNode* leftTail=leftPair.second;
                ...
                struct TreeNode* rightHead=rightPair.first;
                struct TreeNode* rightTail=rightPair.second;
                ...
                pair<TreeNode*, TreeNode*> retValue={leftHead, rightTail};
                return retValue;
            }
            else
...
int main(void)
{
    ...
    if(BT.createBinaryTree())
    {
        ...
        pair<BinaryTree::TreeNode*, BinaryTree::TreeNode*> headPair=BT.btToDLL(&(BT.root)); BT.root=headPair.first;
        cout<<"The traversal of doubly linked list is:"<<endl;
