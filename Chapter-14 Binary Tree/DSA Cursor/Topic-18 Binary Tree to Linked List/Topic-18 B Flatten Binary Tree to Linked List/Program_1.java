...
class BinaryTree{
    ...
    void SLLTraversal(TreeNode headPtr)
    {
    ...
    TreeNode btToSLL(TreeNode root_add)
    {
        ...
        if(root_add!=null)
        {
            ...
            TreeNode tailLeft=btToSLL(root_add.left);
            TreeNode tailRight=btToSLL(root_add.right);
            ...
            if(tailLeft==null && tailRight==null) return root_add;
            else if(tailLeft!=null && tailRight==null) return tailLeft;
...
public class Program_1
{
    ...
    public static void main(String[] args)
    {
        ...
        if(BT.createBinaryTree())
        {
            ...
            BT.btToSLL(BT.root);
            System.out.println("The traversal of singly linked list is:");
