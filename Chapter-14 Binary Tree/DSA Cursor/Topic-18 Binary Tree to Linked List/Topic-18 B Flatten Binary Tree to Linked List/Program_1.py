...
class BinaryTree:
        ...
        def SLLTraversal(self, headPtr):
            ...
            while(headPtr):
                ...
                print(f"The address of next node is:{headPtr.right}")
                print()
        ...
        def btToSLL(self, root_add):
            ...
            if(root_add):
                ...
                tailLeft=self.btToSLL(root_add.left)
                tailRight=self.btToSLL(root_add.right)
                ...
                if(not(tailLeft) and not(tailRight)):
                    return root_add
                elif(tailLeft and not(tailRight)):
                    return tailLeft
                else:
                    return tailRight
            else:
...
if(BT.createBinaryTree()):
    ...
    BT.btToSLL(BT.root)
    print("The traversal of singly linked list is:")
