...
class BinaryTree{
    ...
    public:
        ...
        void allPaths(struct TreeNode** root_add, vector<int>& path)
        {
...
int main(void)
{
    ...
    if(BT.createBinaryTree())
    {
        ...
        /*Declaring a variable of the vector type(user defined), and
        calling allPaths function to print all the paths of binary tree*/
        vector<int> vec;
        cout<<"All the paths of the binary tree are:"<<endl;
        BT.allPaths(&(BT.root), vec);
