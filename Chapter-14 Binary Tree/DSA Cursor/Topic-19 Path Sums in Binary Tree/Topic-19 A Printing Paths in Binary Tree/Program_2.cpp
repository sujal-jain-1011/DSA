...
class BinaryTree{
    ...
    public:
        ...
        void allPaths(struct TreeNode** root_add)
        {
            ...
            vector<int> rootVal; rootVal.push_back((*(root_add))->val);
            ...
            while(!qu.empty())
            {
                ...
                if(!(currentNode->left) && !(currentNode->right))
                {
                    ...
                    for(size_t iter=0; iter<sz; iter++) cout<<current[iter]<<" "; cout<<endl;
                }
                ...
                if(currentNode->left)
                {
                    ...
                    vector<int> leftChild(current.begin(), current.end());
                ...
                if(currentNode->right)
                {
                    ...
                    vector<int> rightChild(current.begin(), current.end());
