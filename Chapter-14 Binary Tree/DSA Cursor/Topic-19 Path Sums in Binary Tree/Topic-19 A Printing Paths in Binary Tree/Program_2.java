...
class BinaryTree{
    ...
    /*Member function of class: to print all the root to leaf paths in the given binary tree*/
    void allPaths(TreeNode root_add)
    {
        ...
        List<Integer> rootVal=new ArrayList<>(); rootVal.add(root_add.val);
        ...
        while(!qu.isEmpty())
        {
            ...
            if((currentNode.left==null) && (currentNode.right==null))
            {
                ...
                for(int iter=0; iter<sz; iter++) System.out.print(current.get(iter)+" "); System.out.println();
            }
