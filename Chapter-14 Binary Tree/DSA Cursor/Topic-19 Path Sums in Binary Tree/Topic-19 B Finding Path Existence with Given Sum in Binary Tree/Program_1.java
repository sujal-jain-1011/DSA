...
class BinaryTree{
    ...
    void isPathExist(TreeNode root_add, int targetSum, int sum)
    {
        ...
        if(root_add!=null && !isFound)
        {
            ...
            sum+=root_add.val;
            if(root_add.left==null && root_add.right==null && sum==targetSum) {isFound=true; return;}
...
public class Program_1
{
    ...
    public static void main(String[] args)
    {
        ...
        if(BT.createBinaryTree())
        {
            ...
            if(BT.isFound) System.out.println("Path exists in the binary tree with given sum!");
