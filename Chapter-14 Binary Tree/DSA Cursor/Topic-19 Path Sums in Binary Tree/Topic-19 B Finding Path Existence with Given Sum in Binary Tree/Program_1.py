...
class BinaryTree:
        ...
        def __init__(self):
            self.capacity, self.front, self.rear, self.isFound=0, -1, -1, False
        ...
        def isPathExist(self, root_add, targetSum, sum):
            ...
            if(root_add!=None and not(self.isFound)):
                ...
                self.isPathExist(root_add.left, targetSum, sum)
                self.isPathExist(root_add.right, targetSum, sum)
