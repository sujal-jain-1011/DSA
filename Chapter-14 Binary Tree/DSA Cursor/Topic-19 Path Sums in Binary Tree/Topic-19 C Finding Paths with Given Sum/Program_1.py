...
class BinaryTree:
        ...
        def printPaths(self, root_add, targetSum, sum):
            ...
            if(root_add):
                ...
                if(not(root_add.left) and not(root_add.right) and sum==targetSum):
                ...
                self.printPaths(root_add.left, targetSum, sum)
                self.printPaths(root_add.right, targetSum, sum)
