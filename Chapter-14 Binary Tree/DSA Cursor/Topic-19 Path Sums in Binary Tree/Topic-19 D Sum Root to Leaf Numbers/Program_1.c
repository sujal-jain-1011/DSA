...
/*Function to find the sum of all the numbers formed from path from root to leaf*/
...
int main(void)
{
    ...
    if(createBinaryTree())
    {
        ...
        printf("The sum of all the numbers formed from path from root to leaf is:%d\n", totalSum);
