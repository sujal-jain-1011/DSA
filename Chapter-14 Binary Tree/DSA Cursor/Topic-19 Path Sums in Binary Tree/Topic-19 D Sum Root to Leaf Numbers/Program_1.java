...
we are also going to find all sum of all numbers formed from path from root to leaf*/
...
class BinaryTree{
    ...
    void sumRootToLeaf(TreeNode root_add, int d)
    {
...
public class Program_1
{
    ...
    public static void main(String[] args)
    {
        ...
        if(BT.createBinaryTree())
        {
            ...
            System.out.println("The sum of all the numbers formed from path from root to leaf is:"+BT.totalSum);
        }
        else
