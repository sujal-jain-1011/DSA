...
class BinaryTree:
        ...
        def sumRootToLeaf(self, root_add, d):
            ...
            if(root_add):
                ...
                self.sumRootToLeaf(root_add.left, d)
                self.sumRootToLeaf(root_add.right, d)
...
if(BT.createBinaryTree()):
    ...
    print(f"The sum of all the numbers formed from path from root to leaf is:{BT.totalSum}")
else:
