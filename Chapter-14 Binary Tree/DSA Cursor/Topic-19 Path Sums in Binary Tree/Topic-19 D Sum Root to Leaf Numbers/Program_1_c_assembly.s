...
.LFB14:
	...
	testq	%rax, %rax
	jne	.L42
	movl	totalSum(%rip), %edx
	movl	-12(%rbp), %eax
	addl	%edx, %eax
	movl	%eax, totalSum(%rip)
	jmp	.L40
.L42:
	movq	-8(%rbp), %rax
	movq	(%rax), %rax
...
.L40:
	...
	.cfi_endproc
.LFE14:
	.size	sumRootToLeaf, .-sumRootToLeaf
...
.LC12:
	...
	.align 8
.LC13:
	.string	"The sum of all the numbers formed from path from root to leaf is:%d\n"
.LC14:
