...
class BinaryTree:
        ...
        def sumRootToLeaf(self, root_add):
            ...
            while(bool(qu)):
                ...
                qr=qu.popleft()
                currentNode, digit=qr.ref, qr.sm
                ...
                if(currentNode.left):
                    ...
                    leftSum=(10*digit)+(currentNode.left).val
                ...
                if(currentNode.right):
                    ...
                    rightSum=(10*digit)+(currentNode.right).val
...
if(BT.createBinaryTree()):
    ...
    print(f"Summation of all root to leaf path numbers:{BT.sumRootToLeaf(BT.root)}")
else:
