...
class BinaryTree{
    ...
    public:
        ...
        /*Member function of class: to find the maximum path sum (not necessarily passing through root) in binary tree*/
...
int main(void)
{
    ...
    if(BT.createBinaryTree())
    {
        ...
        int mps=INT_MIN; BT.maxPathSum(&(BT.root), &mps);
        cout<<"The maximum path sum in the binary tree is:"<<mps<<endl;
