...
class BinaryTree:
        ...
        def populateMap(self, root_add, mp, currLevel):
            ...
            if(root_add):
                ...
                if currLevel not in mp:
                    mp[currLevel]=[]
                mp[currLevel].append(root_add)
                self.populateMap(root_add.left, mp, currLevel+1)
                self.populateMap(root_add.right, mp, currLevel)
