...
class BinaryTree{
    ...
    public:
        ...
        /*Member function of class: to find the diameter (length of longest path) of the binary tree*/
...
int main(void)
{
    ...
    if(BT.createBinaryTree())
    {
        ...
        llui diam=0; BT.diameter(&(BT.root), &diam);
        if(diam==0) cout<<"The diameter of binary tree is:"<<diam<<endl;
        else cout<<"The diameter of binary tree is:"<<(diam-1)<<endl;
