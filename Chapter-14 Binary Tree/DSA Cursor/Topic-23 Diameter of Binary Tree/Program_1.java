...
class BinaryTree{
    ...
    int diameter(TreeNode root_add, int[] diam)
    {
        ...
        if(root_add!=null)
        {
            ...
            int leftHeight=diameter(root_add.left, diam);
            int rightHeight=diameter(root_add.right, diam);
            ...
            diam[0]=Math.max(diam[0], leftHeight+rightHeight+1);
...
public class Program_1
{
    ...
    public static void main(String[] args)
    {
        ...
        if(BT.createBinaryTree())
        {
            ...
            int[] diam=new int[1]; diam[0]=0; BT.diameter(BT.root, diam);
            if(diam[0]==0) System.out.println("The diameter of binary tree is:"+diam[0]);
            else System.out.println("The diameter of binary tree is:"+(diam[0]-1));
        }
        else
