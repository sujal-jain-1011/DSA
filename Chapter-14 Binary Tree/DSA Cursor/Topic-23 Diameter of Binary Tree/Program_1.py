...
class BinaryTree:
        ...
        def diameter(self, root_add, diam):
            ...
            if(root_add):
                ...
                leftHeight=self.diameter(root_add.left, diam)
                rightHeight=self.diameter(root_add.right, diam)
                ...
                diam[0]=max(diam[0], leftHeight+rightHeight+1)
...
if(BT.createBinaryTree()):
    ...
    diam=[0]
    BT.diameter(BT.root, diam)
    if(diam[0]==0):
        print(f"The diameter of binary tree is:{diam[0]}")
    else:
        print(f"The diameter of binary tree is:{(diam[0]-1)}")
else:
