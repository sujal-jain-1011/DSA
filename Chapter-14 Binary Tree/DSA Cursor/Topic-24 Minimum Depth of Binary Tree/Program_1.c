...
/*Function to find the minimum of two long long unsigned int*/
llui min(llui a, llui b){return a<=b?a:b;}

/*Function to find the minimum depth of given binary tree recursively*/
