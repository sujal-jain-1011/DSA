...
class BinaryTree{
    ...
    int minDepth(TreeNode root_add)
    {
        ...
        if(root_add!=null)
        {
            ...
            if(root_add.left!=null) leftHeight=minDepth(root_add.left);
            if(root_add.right!=null) rightHeight=minDepth(root_add.right);

            /*Handling the corner case: when both the subtrees of current node are null*/
            if(root_add.left==null && root_add.right==null) return 1;
...
public class Program_1
{
    ...
    public static void main(String[] args)
    {
        ...
        if(BT.createBinaryTree())
        {
            ...
            System.out.println("The minimum depth of binary tree is:"+BT.minDepth(BT.root));
        }
        else
