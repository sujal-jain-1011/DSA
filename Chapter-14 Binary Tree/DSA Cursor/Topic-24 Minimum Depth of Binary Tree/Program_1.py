...
class BinaryTree:
        ...
        def minDepth(self, root_add):
            ...
            if(root_add):
                ...
                leftHeight, rightHeight=math.inf, math.inf
                if(root_add.left):
                    leftHeight=self.minDepth(root_add.left)
                if(root_add.right):
                    rightHeight=self.minDepth(root_add.right)
...
if(BT.createBinaryTree()):
    ...
    print(f"The minimum depth of binary tree is:{BT.minDepth(BT.root)}")
else:
