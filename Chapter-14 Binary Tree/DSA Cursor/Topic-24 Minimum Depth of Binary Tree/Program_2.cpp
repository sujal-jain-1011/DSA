...
class BinaryTree{
    ...
    public:
        ...
        /*Member function of class: to find the minimum depth of given binary tree iteratively*/
        llui minDepth(struct TreeNode** root_add)
        {
            /*Declaring a variable to store the minimum depth of binary tree*/
            llui lc=0;
            ...
            {
                /*Declaring a queue data structure and, enqueuing root node and NULL into the created
                ...
                while(!queLOT.empty())
                {
                    ...
                    else
                    {
                        ...
                        lc+=1; if(!queLOT.empty()) queLOT.push(nullptr);
                    }
                }
            }

            /*Returning the minimum level of the binary tree stored in lc variable+1*/
            return lc+1;
        }
