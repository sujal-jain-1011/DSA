...
class BinaryTree{
    ...
    /*Member function of class: to find the minimum depth of the binary tree iteratively*/
        ...
        else
        {
            ...
            while(!queLOT.isEmpty())
            {
                ...
                if(qptr!=null)
                {
                    ...
                    if(qptr.left==null && qptr.right==null) break;
                }
                else
                {
                    /*Enqueuing NULL into queue to mark the ending of the current level*/
                    lc+=1; if(!queLOT.isEmpty()) queLOT.offer(null);
                }
            }
        }
