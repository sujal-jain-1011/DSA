...
class BinaryTree{
    ...
    void populateNext(TreeNode root_add)
    {
        ...
        TreeNode ptr=root_add, head=root_add, headNext=root_add.left;
        while(head!=null)
        {
            ...
            if(ptr.left!=null) (ptr.left).next=ptr.right; else break;
            ...
            if(ptr==null)
            {
                ...
                if(headNext==null) break; else{ptr=head=headNext; headNext=headNext.left;}
            }
        }
    }
