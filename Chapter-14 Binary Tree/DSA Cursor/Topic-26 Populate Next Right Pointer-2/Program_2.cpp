...
class BinaryTree{
    ...
    public:
        ...
        next pointer defining a function that will create a new node for the binary tree when called*/
        struct TreeNode{
            int val;
        ...
        /*Member function of class: to populate next pointer in each node of the perfect binary tree*/
        void populateNext(struct TreeNode** root_add)
        {
            ...
            if(!(*(root_add)))
            {
                ...
                cout<<"Binary tree is empty can't populate next right pointer!"<<endl;
                return;
            }
        ...
        /*Member function of class: to print the level order traversal of binary tree using queue data structure*/
            ...
            else
            {
                ...
                while(!queLOT.empty())
                {
                    ...
                    if(qptr)
                    {
                        ...
                        cout<<qptr->val<<" "; if(qptr->next) cout<<(qptr->next)->val<<" "; else cout<<"NULL ";
...
int main(void)
{
    ...
    if(BT.createBinaryTree())
    {
        ...
        BT.populateNext(&(BT.root)); cout<<"The level order traversal of binary tree is:"<<endl;
