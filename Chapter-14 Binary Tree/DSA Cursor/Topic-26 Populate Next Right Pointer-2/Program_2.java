...
class BinaryTree{
    ...
    /*Defining a class for binary tree node that contains data, left, right child pointers and
    ...
    /*Member function of class: to populate next pointer in each node of binary tree*/
    void populateNext(TreeNode root_add)
    {
        ...
        if(root_add==null)
        {
            ...
            System.out.println("Binary tree is empty can't populate next right pointer!");
            return;
        }

        /*Running a loop to populate next pointer of each node in the binary tree*/
        TreeNode ptr=root_add, head=root_add, nptr,
        headNext=root_add.left!=null?root_add.left:root_add.right;
        while(head!=null)
        {
            ...
            if(ptr.left!=null)
            {
                ...
                if(ptr.right!=null) ptr.left.next=ptr.right;
                else
                {
                    ...
                    while(nptr!=null)
                    {
                        ...
                        if(nptr.left!=null){ptr.left.next=nptr.left; break;}
                        else if(nptr.right!=null){ptr.left.next=nptr.right; break;}
                        nptr=nptr.next;
                    }
                }
            }
            if(ptr.right!=null)
            {
                ...
                {
                    /*Checking whether left or right child of next node of ptr exists or not*/
                    if(nptr.left!=null){ptr.right.next=nptr.left; break;}
                    else if(nptr.right!=null){ptr.right.next=nptr.right; break;}
                    nptr=nptr.next;
                }
            }ptr=ptr.next;
            ...
            if(ptr==null)
            {
                ...
                if(headNext!=null)
                {
                    ...
                    ptr=head=headNext; TreeNode hN=headNext;
                    while(hN!=null && (hN.left==null && hN.right==null)) hN=hN.next;
                    if(hN!=null) headNext=hN.left!=null?hN.left:hN.right; else break;
                }
                else break;
            }
        }
    ...
    void levelOrderTraversal(TreeNode root_add)
    {
        ...
        else
        {
            ...
            while(!queLOT.isEmpty())
            {
                ...
                if(qptr!=null)
                {
                    ...
                    System.out.print(qptr.val+" "); if(qptr.next!=null) System.out.print((qptr.next).val+" "); else System.out.print("NULL ");
...
public class Program_2
{
    ...
    public static void main(String[] args)
    {
        ...
        if(BT.createBinaryTree())
        {
            ...
            BT.populateNext(BT.root); System.out.println("The level order traversal of binary tree is:");
