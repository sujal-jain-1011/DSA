...
class BinaryTree:
        ...
        class TreeNode:
            def __init__(self, data):
                self.val, self.left, self.right, self.next=data, None, None, None
        ...
        def populateNext(self, root_add):
            ...
            if(not(root_add)):
                ...
                print("Binary tree is empty can't populate next right pointer!")
                return

            #Running a loop to populate next pointer of each node in the binary tree
            ptr, head, nptr=root_add, root_add, None
            headNext=root_add.left if(root_add.left) else root_add.right
            while(head):
                ...
                if(ptr.left):
                    ...
                    if(ptr.right):
                        ...
                        while(nptr):
                            ...
                            if(nptr.left):
                                ptr.left.next=nptr.left
                                break
                            elif(nptr.right):
                                ptr.left.next=nptr.right
                                break
                            nptr=nptr.next
                if(ptr.right):
                    ...
                    while(nptr):
                        #Checking whether left or right child of next node of ptr exists or not
                        if(nptr.left):
                            ptr.right.next=nptr.left
                            break
                        elif(nptr.right):
                            ptr.right.next=nptr.right
                            break
                        nptr=nptr.next
                ptr=ptr.next
                ...
                if(not(ptr)):
                    ...
                    if(headNext):
                        ...
                        head=headNext
                        hN=headNext
                        while(hN and (not(hN.left) and not(hN.right))):
                            hN=hN.next
                        if(hN):
                            headNext=hN.left if(hN.left) else hN.right
                        else:
                            break
                    else:
                        break
        ...
        def levelOrderTraversal(self, root_add):
...
if(BT.createBinaryTree()):
    ...
    BT.populateNext(BT.root)
    print("The level order traversal of binary tree is:")
