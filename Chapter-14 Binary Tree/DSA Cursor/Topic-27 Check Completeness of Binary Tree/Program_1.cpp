...
class BinaryTree{
    ...
    public:
        ...
        /*Member function of class: to check whether the binary tree is complete binary tree or not*/
        bool checkCompleteness(struct TreeNode** root_add)
        {
            ...
            else
            {
                ...
                bool isLastNode=false; queue<struct TreeNode*> queLOT;
                ...
                while(!queLOT.empty())
                {
                    ...
                    if(qptr && !isLastNode)
                    {
                        ...
                        if(!(qptr->left) && !(qptr->right)) isLastNode=true;
                        else if(qptr->left && !(qptr->right)){isLastNode=true; queLOT.push(qptr->left);}
                        else if(!(qptr->left) && qptr->right) return false;
                        else if(qptr->left && qptr->right)
                        {
                            ...
                            queLOT.push(qptr->left); queLOT.push(qptr->right);
                        }
                    }
                    else if(qptr && isLastNode)
                    {
                        ...
                        if(qptr->left || qptr->right) return false;
                    }
                    else
                    {
                ...
                /*Returning one/true to caller since binary tree is complete binary tree*/
                return true;
            }
        }
...
int main(void)
{
    ...
    if(BT.createBinaryTree())
    {
        ...
        if(BT.checkCompleteness(&(BT.root))) cout<<"Binary tree is complete binary tree!"<<endl;
        else cout<<"Binary tree is not a complete binary tree!"<<endl;
