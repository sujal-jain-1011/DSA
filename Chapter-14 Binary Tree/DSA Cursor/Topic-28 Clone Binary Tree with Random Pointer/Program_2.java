...
/*Importing Scanner class from java.util for taking the input from user and
ThreadLocalRandom class to use rand method for generating random indices for array*/
...
class BinaryTree{
    ...
    /*Defining a class for binary tree node that contains data, left and right child pointers and
    ...
    class TreeNode{
        ...
        TreeNode(int data) {val=data; left=null; right=null; random=null;}
    };
    TreeNode root;
    TreeNode ptr; 
    TreeNode []que;
    TreeNode []randomArray;
    ...
    boolean createBinaryTree()
    {
        ...
        try{randomArray=new TreeNode [capacity];}
        catch(OutOfMemoryError e){System.out.println("Memory allocation failed for random array!"); return false;}
        int randomIter=0;
    ...
    /*Member function of class: to populate random field in each node of original binary tree*/
    private void populateRandomOriginal(TreeNode root_add)
    {
        ...
        if(root_add!=null)
        {
            ...
            int randomIndex=ThreadLocalRandom.current().nextInt(capacity);
            root_add.random=randomArray[randomIndex];
    ...
    void preorder(TreeNode root_add)
    {
        ...
        {    
            ...
            if(root_add.random!=null)
            System.out.println("TreeNode value pointed to by random pointer of this TreeNode:"+(root_add.random).val);
            else System.out.println("TreeNode pointed to by random pointer of this TreeNode is NULL!");
