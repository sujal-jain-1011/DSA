...
"""Importing math module for using positive infinity
and random module for generating random indices"""
import math
import random
...
class BinaryTree:
        ...
        def __init__(self):
            ...
            self.root, self.ptr, self.que, self.randomArray=None, None, None, None
        ...
        def createBinaryTree(self):
            ...
            self.randomArray=[None for _ in range(self.capacity)]
            randomIter=0
            ...
            self.randomArray[randomIter]=root_start
            randomIter+=1
            ...
            while(iter<self.capacity):
                ...
                if(not(currentTreeNode.left)):
                    ...
                    self.randomArray[randomIter]=left_child
                    randomIter+=1
                ...
                if(iter<self.capacity and not(currentTreeNode.right)):
                    ...
                    self.randomArray[randomIter]=right_child
                    randomIter+=1
            ...
            self.populateRandomOriginal(root_start)
        ...
        def populateRandomOriginal(self, root_add):
            ...
            if(root_add):
                ...
                randomIndex=random.randint(0, self.capacity-1)
                root_add.random=self.randomArray[randomIndex]
                self.populateRandomOriginal(root_add.left)
                self.populateRandomOriginal(root_add.right)
        ...
        def preorder(self, root_add):
            ...
            if(root_add):
                ...
                if(root_add.random):
                    print(f"TreeNode value pointed to by random pointer of this TreeNode:{root_add.random.val}")
                else:
                    print("TreeNode pointed to by random pointer of this TreeNode is NULL!")
