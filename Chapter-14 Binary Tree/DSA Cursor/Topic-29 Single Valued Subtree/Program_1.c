...
and we are also going to find number of univalued subtrees in the given binary tree*/
...
/*Function to find the number of univalued subtrees in the given binary tree*/
...
int main(void)
{
    ...
    if(createBinaryTree())
    {
        ...
        llui count=0;  uniValue(&root, &count);
        printf("Number of univalued subtrees in binary tree:%llu\n", count);
