...
class BinaryTree{
    ...
    int uniValue(TreeNode root_add, int[] count)
    {
        ...
        if(root_add!=null)
        {
            ...
            else if(((leftVal==0) || root_add.val==leftVal) && ((rightVal==0) || root_add.val==rightVal))
            {
                /*Incrementing count variable and returning the value of the current node*/
                count[0]+=1; return root_add.val;
            }
            else if(!(((leftVal==0) || root_add.val==leftVal) && ((rightVal==0) || root_add.val==rightVal)))
            return -1;
...
public class Program_1
{
    ...
    public static void main(String[] args)
    {
        ...
        if(BT.createBinaryTree())
        {
            ...
            int[] count=new int[1]; count[0]=0;  BT.uniValue(BT.root, count);
            System.out.println("Number of univalued subtrees in binary tree:"+count[0]);
        }
        else
