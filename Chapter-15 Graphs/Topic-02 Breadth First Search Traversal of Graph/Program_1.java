    ...
    void bfs(GraphNode[] start)
    {
        ...
        for(long iter=0; iter<capacity; iter++)
        {
            ...
            if(!visited.get((start[(int)iter].dt).val))
            {
                ...
                visited.put((start[(int)iter].dt).val, true); que.offer(start[(int)iter]);
                while(!que.isEmpty())
                {
                    ...
                    AdjNeigh ptr=curr.adj; printDT(curr.dt); System.out.print(" ");
                    while(ptr!=null)
                    {
...
public class Program_1
{
    ...
    public static void main(String[] args)
    {
        ...
        if(gH.createGraph(dataType.intData))
        {
            ...
            System.out.println("The BFS traversal of given graph is:"); gH.bfs(gH.GN); System.out.println();
        }
