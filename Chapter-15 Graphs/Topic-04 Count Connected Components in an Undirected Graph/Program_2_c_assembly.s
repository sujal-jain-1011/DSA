...
.L63:
	...
	.cfi_endproc
.LFE16:
	.size	dfsHelper, .-dfsHelper
	.globl	countConnected
	.type	countConnected, @function
countConnected:
.LFB17:
	.cfi_startproc
	endbr64
...
.L71:
	...
	.cfi_endproc
.LFE17:
	.size	countConnected, .-countConnected
	.section	.rodata
.LC22:
	.string	"Successfully created graph!"
	.align 8
.LC23:
	.string	"Total number of connected components in graph:%u\n"
.LC24:
