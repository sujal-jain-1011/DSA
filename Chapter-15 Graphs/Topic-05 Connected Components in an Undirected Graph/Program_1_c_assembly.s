...
.LFE15:
	...
	.align 8
.LC22:
	.string	"Nodes of connected component %llu are:\n"
	.text
	.globl	printConnected
	.type	printConnected, @function
printConnected:
.LFB16:
	.cfi_startproc
	endbr64
...
.L72:
	...
	.cfi_endproc
.LFE16:
	.size	printConnected, .-printConnected
	.section	.rodata
.LC23:
	.string	"Successfully created graph!"
	.align 8
.LC24:
	.string	"Connected components in the graph are:"
.LC25:
